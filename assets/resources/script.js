...
class ConfettiCannon {
    ...
    tick = () => {
        const yBound = document.documentElement.clientHeight - 10;
        ...
        const outs = this.entities.filter((e) => {
            return Number.parseInt(e.element.style.top) >= yBound
                ...
                || Number.parseInt(e.element.style.left) >= document.documentElement.clientWidth - 5;
        });
        outs.forEach((e) => {
...
const rightConfettiCannon = new ConfettiCannon(pages.complete.element, 100, document.documentElement.clientWidth - 10, 800, -180 + 70);
...
function celebrate() {
    ...
    rightConfettiCannon.reset(document.documentElement.clientWidth - 10, 800, -180 + 70);
